...
ACostumeClashCharacter::ACostumeClashCharacter()
{
...
void ACostumeClashCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//	//Moving
	//	EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACostumeClashCharacter::Move);
...
void ACostumeClashCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACostumeClashCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
